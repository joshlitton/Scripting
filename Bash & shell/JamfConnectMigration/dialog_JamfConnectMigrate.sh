...
# #                # #
# 4 = Log File
# 5 = Debug Mode [true (default) | false]
# 6 = Welcome Dialog [true (default) | false]
# 7 = Completion Action [wait | sleep (with seconds) | Shut Down | Shut Down Attended | Shut Down Confirm | Restart | Restart Attended (default) | Restart Confirm | Log Out | Log Out Attended | Log Out Confirm]
    ...
    "steps": [
        {
            ...
            "icon": "cfd63778b8e9a5d4b2b22ff2b54ab440b1895d6a24e36b326ff19cb0d9b38901",
            "progresstext": "Jamf Connect is the leader in synchonized authentication for your MacBook. ",
            "trigger_list": [
                {
                    "trigger": "install-jamfconnect",
        ...
        {
            "listitem": "Removing XCreds",
            "icon": "a65aa18bbf98cea95f7d21617c54bd5d7a54c72647c639c03d75072dc71c2b1b",
            "progresstext": "XCreds is the original authentication provider that is being replaced by Jamf Connect.",
            "trigger_list": [
                {
                    "trigger": "remove-xcreds",
                    "path": ""
                }
            ]
        },
        {
            "listitem": "Temporary Network",
            "icon": "5a201a97b8acb43e6d3351ecc5eb718580522b983ce1b78c8d4a440247b1f93f",
            "progresstext": "Installing WiFi profile to ensure connectivity at the login screen during next boot.",
            "trigger_list": [
                {
                    "trigger": "migrate-ssid",
                    "path": ""
                }
            ]
        },
        {
            "listitem": "Setting auth provider",
            "icon": "cc35d2de4cfdcd672a4be486d1bf149c7866b2d24088f723a6959393d5326071",
            "progresstext": "Setting authentication provider to use Jamf Connect as the primary login",
            "trigger_list": [
                {
                    "trigger": "set-auth",
                    "path": ""
